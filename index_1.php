...
<body>
            ...
            <div class="d-flex flex-column">
                <div class="d-flex align-items-center">
                    ...
                    <a class="navbar-brand d-flex align-items-center" href="#">
                        <img src="images/logo.svg" alt="Gadget Grid logo" style="height:36px;"
    ...
    <section class="top-section container-lg mt-4">
        <div class="row g-4 align-items-stretch">
            <!-- Large hero card -->
            <div class="col-lg-8">
                <div class="hero-big-card animate__animated animate__fadeIn h-100"
                    style="background-image: url('images/spa.jpg')" data-aos="fade-up">
                    <span class="hero-big-card-title">
                        <span class="hero-tag">EXCLUSIVE LAUNCH</span>
                        THE FROSTEAM<br />ALL-IN-ONE FACIAL SPA
                    </span>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="now-trending-card animate__animated animate__fadeIn h-100" data-aos="fade-up"
                    ...
                    <ul class="now-trending-list">
                        <li><span class="trend-num">1</span> DJI Matrice 400: Enterprise-Level...</li>
                        <li><span class="trend-num">2</span> Bose QuietComfort Ultra Earbuds...</li>
                        <li><span class="trend-num">3</span> Trump T1 SM Phone 8002: Gold...</li>
                        <li><span class="trend-num">4</span> ROG Xbox Ally Handhelds: ROG...</li>
                        <li><span class="trend-num">5</span> OnePlus Pad 3: Android Tablet...</li>
                        <li><span class="trend-num">6</span> DJI Matrice 400: Enterprise-Level...</li>
                        <li><span class="trend-num">7</span> Bose QuietComfort Ultra Earbuds...</li>
                        <li><span class="trend-num">8</span> Trump T1 SM Phone 8002: Gold...</li>
                        <li><span class="trend-num">9</span> ROG Xbox Ally Handhelds: ROG...</li>
                        <li><span class="trend-num">10</span> OnePlus Pad 3: Android Tablet...</li>
                    </ul>
                </div>
            </div>
        </div>
